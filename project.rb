...
while i<steps_array.length
  info_hash = steps_array[i]
  info_hash.store(:person,name_array[i%3])
  i+=1
  p info_hash
end
...
# steps_array.each_with_index do |s, i|
#   s[:person] = name_array[i%3]
# end
